---
name: docsync
description: Synchronises .ops/docs-system/** with the current state of the {{GAME_NAME}} codebase after structural changes.
---
...
4. Create a new doc if a changed system does not have one yet — place it in the correct Diataxis category.
5. Update `INDEX.md` for any added or renamed docs.
...
- Never fabricate. Read source before writing.
- Mark uncertainty explicitly (`TODO: verify`).
- Keep prose technical and direct — no filler.
